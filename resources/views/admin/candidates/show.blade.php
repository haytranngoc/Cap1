    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <p><b>Created At: </b>{{ date('M j, Y', strtotime($candidate->created_at)) }}</p>
                <p><b>Update At: </b>{{ date('M j, Y', strtotime($candidate->updated_at)) }}</p>
                <a href="{{route('admin.candidates.getPDF', $candidate->id)}}" ><button class="btn btn-danger">PDF</button></a>
            ...
            <div class="panel-body">
                <div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div><p><b>Date of birth : </b>{{ date('M j, Y', strtotime($candidate->date_of_birth)) }}</p></div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div><p><b>Candidate Type : </b>{{ $candidate->candidateType->name }} <b>,</b><b> Point : </b>{{ $candidate->candidateType->bonus_point }}</p></div>
                        <div><p><b>Area : </b>{{ $candidate->area->name }} <b>,</b> <b>Point : </b>{{ $candidate->area->bonus_point }}</p></div>
                        <div><p><b>School : </b>{{ $candidate->school->name }} <b>,</b> <b>City : </b>{{ $candidate->school->city->name }}</p></div>
                        <div><p><b>Branch : </b>{{ $candidate->branch->name }} <b>,</b> <b>Specialized : </b>{{ $candidate->specialized->name }}</p></div>
